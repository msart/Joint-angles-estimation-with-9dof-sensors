...
def main():
	...
	with open(sys.argv[1], 'w') as f:
		...
		# for i in range(1,10):
			...
			# f.write(str(k) + " " + str(q1[0]) + " " + str(q1[1]) + " " + str(q1[2]) + " " + str(q1[3]) + "\n")
			# print(q1[0], q1[1], q1[2], q1[3])
			# k = k + 1
			# print(q2)
			# print(diff)
			f.write(str(sensor1_gx) + " " + str(sensor1_gy) + " " + str(sensor1_gz) + " " + str(sensor1_ax)  + " "+ str(sensor1_ay) + " " + str(sensor1_az) + " " + str(sensor1_mx) + " " + str(sensor1_my) + " " + str(sensor1_mz) + " " + "\n")
